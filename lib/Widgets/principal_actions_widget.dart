// Archivo: Widgets/principal_actions_widget.dart
...
class PrincipalActionsWidget extends StatelessWidget {
    ...
    return SizedBox(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return _buildCard(action.title, action.iconPath, action.iconData, action.onTap);
        },
      ),
    );
  }
  ...
  Widget _buildCard(String title, String? iconPath, IconData? iconData, VoidCallback onTap) {
